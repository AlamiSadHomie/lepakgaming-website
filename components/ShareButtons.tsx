  ...
  return (
    <div className="mt-12 p-6 bg-gray-800 rounded-xl border border-gray-700">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button
          onClick={shareX}
          className="flex items-center gap-2 px-4 py-2 bg-black hover:bg-gray-900 border border-gray-600 rounded-lg text-sm font-medium transition"
        >
        ...
        <button
          onClick={copyLink}
          className="flex items-center gap-2 px-4 py-2 bg-gray-700 hover:bg-gray-600 border border-gray-600 rounded-lg text-sm font-medium transition"
        >
